    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".portfolio__slider")) new core(".portfolio__slider", {
                modules: [ Navigation, Manipulation, Autoplay, Grid ],
                observer: true,
                observeParents: true,
                speed: 800,
                autoplay: {
            ...
            var r = document.querySelector(".companies-slider--1.swiper-container"), i = document.querySelector(".companies-slider--2.swiper-container"), o = document.querySelector(".portfolio__companies"), s = function() {
                if (r && i) {
                    var e = r.querySelectorAll(".swiper-slide"), t = e.length - 1, n = 1500 * e.length;
                    if (e.length > 1) {
                        var s = window.pageYOffset || document.documentElement.scrollTop, c = new core(r, {
                            slidesPerView: "auto",
                            spaceBetween: 20,
                            speed: 2e3,
                            initialSlide: 0,
                        ...
                        window.addEventListener("scroll", (function() {
                            if ((l = o.getBoundingClientRect()).top >= 0 && l.left >= 0 && l.bottom <= (window.innerHeight || document.documentElement.clientHeight) && l.right <= (window.innerWidth || document.documentElement.clientWidth)) {
                                var e = window.pageYOffset || document.documentElement.scrollTop;
                                e > s ? r.classList.contains("scrolled") || i.classList.contains("scrolled") || (c.slideTo(t, n), 
                                a.slideTo(0, n), r.classList.add("scrolled"), i.classList.add("scrolled")) : r.classList.contains("scrolled") && i.classList.contains("scrolled") && (c.slideTo(0, n), 
                                a.slideTo(t, n), r.classList.remove("scrolled"), i.classList.remove("scrolled")), 
                                s = e <= 0 ? 0 : e;
                            }
                            var l;
                        }));
            ...
            s();
            if (document.querySelector(".main-reviews__slider")) new core(".main-reviews__slider", {
                modules: [ Navigation, Manipulation, Scrollbar ],
                observer: true,
                observeParents: true,
                speed: 800,
                scrollbar: {
            ...
            if (document.querySelector(".more-reviews__slider")) new core(".more-reviews__slider", {
                modules: [ Navigation, Manipulation, Scrollbar ],
                observer: true,
                observeParents: true,
                speed: 800,
            ...
            if (document.querySelector(".articles-popular__slider")) new core(".articles-popular__slider", {
                modules: [ Navigation, Manipulation ],
                observer: true,
                observeParents: true,
                speed: 800,
                slideClass: "articles-preview",
                wrapperClass: "articles-popular__wrapper",
                navigation: {
                    prevEl: ".articles-popular__button-prev",
                    nextEl: ".articles-popular__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1
            ...
            if (document.querySelector(".articles-other__slider")) new core(".articles-other__slider", {
                modules: [ Navigation, Manipulation ],
                observer: true,
                observeParents: true,
                speed: 800,
                slideClass: "articles-preview",
                wrapperClass: "articles-other__wrapper",
                navigation: {
            ...
            if (document.querySelector(".case-other__slider")) new core(".case-other__slider", {
                modules: [ Navigation, Manipulation, Autoplay, Grid ],
                observer: true,
                observeParents: true,
                speed: 800,
                slideClass: "case-other__item",
                wrapperClass: "case-other__wrapper",
                navigation: {
                    prevEl: ".case-other__button-prev",
                    nextEl: ".case-other__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
        ...
        const resizeHandlerSlider = () => {
            if (window.innerWidth > 1120) if (document.querySelector(".cooperation__body")) new core(".cooperation__body", {
                modules: [ Navigation, Manipulation, Autoplay, Scrollbar ],
                observer: true,
                observeParents: true,
                speed: 800,
                slideClass: "cooperation__item",
                wrapperClass: "cooperation__items",
                scrollbar: {
                    el: ".swiper-scrollbar",
                    draggable: true,
                    hide: true
...
***************************************************************************** */
        ...
        if (galleriesVideo.length) {
            ...
            galleriesVideo.forEach((galleryVideo => {
                galleyVideoItems.push({
                    galleryVideo,
                    galleryClass: lightgallery_es5(galleryVideo, {
                        plugins: [ lg_video_min ],
                        licenseKey: "7EC452A9-0CFD441C-BD984C7C-17C8456E"
                    })
                });
            }));
            modules_flsModules.gallery = galleyVideoItems;
        }
        ...
        const video = document.querySelector(".case__video");
        if (video) {
            ...
            let videoId = video.querySelector(".case__video-body").getAttribute("data-video");
            ...
            video.addEventListener("click", (e => {
                ...
                video.querySelector(".case__video-body").appendChild(iframe);
                video.querySelector("button").remove();
            }));
        }
        const h = document.querySelector(".header"), reviewsIcon = document.querySelector(".reviews__main-icon"), reviewsContent = document.querySelector(".reviews__content");
        if (reviewsIcon) {
            function g() {
                if (window.scrollY + h.offsetHeight >= script_offset(reviewsContent).top) reviewsIcon.classList.add("animation"); else reviewsIcon.classList.remove("animation");
            }
            window.addEventListener("scroll", g);
            window.addEventListener("resize", g);
        }
        function script_offset(el) {
        ...
        if (btn) {
            window.addEventListener("scroll", (function() {
                if (window.pageYOffset > 100 && window.pageYOffset <= document.querySelector(".article").getBoundingClientRect().bottom) btn.classList.add("show"); else btn.classList.remove("show");
            }));
